...
const Create = () => {
  ...
  const genarateUploadUrl = useMutation(api.posts.genarateUploadUrl);
  ...
  const handleShare = async () => {
    ...
    try {
      setIsSharing(true);
      const uploadUrl = await genarateUploadUrl();
      ...
      if (uploadResult.status !== 200) throw new Error("Upload fail...");
